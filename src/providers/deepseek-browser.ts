...
import { DeepSeekPlaywrightDriver } from '../browser/deepseek-driver.js';
...
const MODEL_ID = 'browser-deepseek-free';
...
export class DeepSeekBrowserProvider implements Provider {
  readonly id = 'browser-deepseek';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new DeepSeekPlaywrightDriver()) {}
