...
import { ZaiPlaywrightDriver } from '../browser/zai-driver.js';
...
const MODEL_ID = 'browser-zai-glm-5.2';
...
export class ZaiBrowserProvider implements Provider {
  readonly id = 'browser-zai';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new ZaiPlaywrightDriver()) {}
