...
import { GrokPlaywrightDriver } from '../browser/grok-driver.js';
...
const MODEL_ID = 'browser-grok-free';
...
export class GrokBrowserProvider implements Provider {
  readonly id = 'browser-grok';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new GrokPlaywrightDriver()) {}
