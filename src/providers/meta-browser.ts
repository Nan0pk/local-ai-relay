...
import { MetaPlaywrightDriver } from '../browser/meta-driver.js';
...
const MODEL_ID = 'browser-meta-free';
...
export class MetaBrowserProvider implements Provider {
  readonly id = 'browser-meta';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new MetaPlaywrightDriver()) {}
