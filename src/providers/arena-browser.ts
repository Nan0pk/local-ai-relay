...
import { ArenaPlaywrightDriver } from '../browser/arena-driver.js';
...
const MODEL_ID = 'browser-arena-free';
...
export class ArenaBrowserProvider implements Provider {
  readonly id = 'browser-arena';
  private readonly planner = new ConversationPlanner();

  constructor(private readonly driver: BrowserChatDriver = new ArenaPlaywrightDriver()) {}
