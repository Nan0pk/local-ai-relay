...
import { MinimaxPlaywrightDriver } from '../browser/minimax-driver.js';
...
export class MinimaxBrowserProvider implements Provider {
  readonly id = 'browser-minimax';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new MinimaxPlaywrightDriver()) {}
