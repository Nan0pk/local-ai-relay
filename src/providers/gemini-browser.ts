...
import { GeminiPlaywrightDriver } from '../browser/gemini-driver.js';
...
const MODEL_ID = 'browser-gemini-free';
...
export class GeminiBrowserProvider implements Provider {
  readonly id = 'browser-gemini';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new GeminiPlaywrightDriver()) {}
