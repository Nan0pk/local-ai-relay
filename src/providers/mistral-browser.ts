...
import { MistralPlaywrightDriver } from '../browser/mistral-driver.js';
...
const MODEL_ID = 'browser-mistral-free';
...
export class MistralBrowserProvider implements Provider {
  readonly id = 'browser-mistral';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new MistralPlaywrightDriver()) {}
