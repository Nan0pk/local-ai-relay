...
import { ClaudePlaywrightDriver } from '../browser/claude-driver.js';
import type {
...
export class ClaudeBrowserProvider implements Provider {
  ...
  constructor(private readonly driver: BrowserChatDriver = new ClaudePlaywrightDriver()) {}
