...
import { KimiPlaywrightDriver } from '../browser/kimi-driver.js';
...
const MODEL_ID = 'browser-kimi-free';
...
export class KimiBrowserProvider implements Provider {
  readonly id = 'browser-kimi';
  private readonly planner = new ConversationPlanner();
  constructor(private readonly driver: BrowserChatDriver = new KimiPlaywrightDriver()) {}
